    ...
    $(function() {
        ...
        $(".aclModule-add").click(function () {
            $("#dialog-aclModule-form").dialog({
                ...
                open: function(event, ui) {
                    ...
                    //optionStr = $("<option></option>").attr("value", 0).append("-");
        ...
        function bindAclModuleClick() {
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            if (result.ret) {
                                ...
                                showMessage("删除权限模块【" + aclModuleName + "】","操作失败" + result.msg, false);
                            }
                        }
                    });
                }
            ...
            function handleAclModuleSelected(aclModuleId) {
                ...
                var currentAclModele = $("#aclModule_" + aclModuleId + " .dd2-content:first");
                currentAclModele.addClass("btn-yellow");
                currentAclModele.addClass("no-hover");
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result.ret) {
                            ...
                            showMessage("获取权限点和分配的用户和角色",result.msg, false);
                        }
                    }
                });
            });

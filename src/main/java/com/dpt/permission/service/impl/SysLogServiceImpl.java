...
import com.dpt.permission.beans.LogType;
...
import com.dpt.permission.dao.*;
import com.dpt.permission.dto.SearchLogDto;
    ...
    public void recover(int id) {
        ...
        switch (sysLog.getType()) {
            case LogType.TYPE_DEPT:
                ...
                Preconditions.checkNotNull(beforeDept, "待还原的部门不存在了");
            ...
            case LogType.TYPE_USER:
                ...
                Preconditions.checkNotNull(beforeUser, "待还原的用户不存在了");
                if (StringUtils.isBlank(sysLog.getNewValue()) || StringUtils.isBlank(sysLog.getOldValue())) {
                    throw new ParamException("新增和删除操作不做还原");
                }
            ...
            case LogType.TYPE_ACL_MODULE:
                ...
                Preconditions.checkNotNull(beforeAclModule, "待还原的权限模块不存在了");
                if (StringUtils.isBlank(sysLog.getNewValue()) || StringUtils.isBlank(sysLog.getOldValue())) {
                    throw new ParamException("新增和删除操作不做还原");
                }
            ...
            case LogType.TYPE_ACL:
                ...
                Preconditions.checkNotNull(beforeAcl, "待还原的权限点不存在了");
                if (StringUtils.isBlank(sysLog.getNewValue()) || StringUtils.isBlank(sysLog.getOldValue())) {
                    throw new ParamException("新增和删除操作不做还原");
                }
            ...
            case LogType.TYPE_ROLE:
                ...
                Preconditions.checkNotNull(beforeRole, "待还原的角色不存在了");
                if (StringUtils.isBlank(sysLog.getNewValue()) || StringUtils.isBlank(sysLog.getOldValue())) {
                    throw new ParamException("新增和删除操作不做还原");
                }
